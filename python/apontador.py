...
class ApontadorAPI(object):
    ...
    def __init__(self, consumer_key=None, consumer_secret=None,
        ...
        if self._consumer_key and self._consumer_secret:
            base64string = base64.b64encode('%s:%s' % (self._consumer_key,
                                                       self._consumer_secret))
            self._basic_auth_header = "Basic %s" % base64string

        # token and secret that allow access to users data. Used for oauth
        # requests
        self._oauth_token = oauth_token
        self._oauth_token_secret = oauth_token_secret

        if self._oauth_token and self._oauth_token_secret:
            self._access_token = oauth.OAuthToken(self._oauth_token,
                                                  self._oauth_token_secret)
        else:
            self._access_token = None

        self._consumer = oauth.OAuthConsumer(self._consumer_key,
                                             self._consumer_secret)
    ...
    def _call_basic_auth_ws(self, url, params):
        ...
        http = httplib2.Http()
        response, content = http.request(url + querystring, "GET",
    ...
    def _call_oauth_ws(self, url, params=None, http_method="GET"):
        ...
        request = oauth.OAuthRequest(http_method=http_method, http_url=url,
                                     parameters=params)
    ...
    def search_places(self, q, category_id=None, sort_by=None, order=None,
                      rating=None, page=None, limit=None, user_id=None,
                      type=None):

        params = {"q": q}

        self._process_optional_parameters(params, category_id=category_id,
    ...
    def search_places_by_address(self, city, state, country=None, street=None,
                                 number=None, district=None, radius_mt=None,
                                 term=None, category_id=None, sort_by=None,
                                 order=None, rating=None, page=None,
                                 limit=None, user_id=None, type=None):

        params = {"city": city, "state": state}
        self._process_optional_parameters(params, country=country,
                                          street=street, number=number,
                                          district=district,
                                          radius_mt=radius_mt, term=term,
        ...
        response = self._call_basic_auth_ws(SEARCH_PLACES_BY_ADDRESS_URL,
                                            params)
        return response

    def search_places_by_zipcode(self, zipcode, radius_mt=None, term=None,
                                 category_id=None, sort_by=None, order=None,
                                 rating=None, page=None, limit=None,
                                 user_id=None, type=None):
        ...
        response = self._call_basic_auth_ws(SEARCH_PLACES_BY_ZIPCODE_URL,
                                            params)
        return response
    ...
    def search_places_by_box(self, se_lat, se_lng, nw_lat, nw_lng,
        ...
        self._process_optional_parameters(params, term=term,
                                          category_id=category_id,
                                          sort_by=sort_by, order=order,
                                          rating=rating, page=page,
                                          limit=limit,
    ...
    def search_users_by_name(self, name, page=None, limit=None, type=None):
        params = {"name": name}
        self._process_optional_parameters(params, page=page, limit=limit,
                                          type=type)
        response = self._call_basic_auth_ws(SEARCH_USERS_BY_NAME_URL, params)
        return response

    def search_users_by_location(self, city, state, page=None, limit=None,
                                 type=None):
        params = {"city": city, "state": state}
        self._process_optional_parameters(params, page=page, limit=limit,
                                          type=type)
        response = self._call_basic_auth_ws(SEARCH_USERS_BY_LOCATION_URL,
                                            params)
        return response
    ...
    def get_user_places(self, userid=None, page=None, limit=None, type=None):
        params = {}
        self._process_optional_parameters(params, type=type, limit=limit,
                                          page=page)
        if userid:
    ...
    def create_new_place(self, name=None, address_street=None,
                         address_number=None,
                         address_complement=None,
                         address_district=None, address_city_name=None,
                         address_city_state=None,
                         address_city_country=None,
                         point_lat=None, point_lng=None, phone_country=None,
                         phone_area=None,
                         phone_number=None, category_id=None,
                         subcategory_id=None, description=None,
        ...
        self._process_optional_parameters(params,
                                    ...
                                    tags=tags, icon_url=icon_url,
                                    other_url=other_url, type=type)

        response = self._call_oauth_ws(CREATE_NEW_PLACE_URL, params,
                                       http_method="PUT")
        return response
